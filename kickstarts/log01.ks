...
network --activate --hostname=log01.ipa.gmonlab.local --bootproto=static --device=eth0 --ip=192.168.1.200 --netmask=255.255.255.0 --gateway=192.168.1.1 --nameserver 8.8.8.8,8.8.4.4
