...
network --activate --hostname=svr01.ipa.gmonlab.local --bootproto=static --device=eth0 --ip=192.168.1.203 --netmask=255.255.255.0 --gateway=192.168.1.1 --nameserver 192.168.1.201,192.168.1.202
...
hostnamectl set-hostname svr01.ipa.gmonlab.local
